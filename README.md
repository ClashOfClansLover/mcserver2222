# MCServer setup guide 

MCServer is a powerful, fully customizable platform that lets you host and manage your own Minecraft server (Java or Bedrock) using `Google Cloud shell` —for ***free***, and with ***no credit card needed***. Designed with gamers in mind, MCServer simplifies the process from setup to launch, handling everything from configuration to server management, all on an Ubuntu/Debian system. Dive into your personalized Minecraft world without the hassle!  
...
- **One-Click Builds & Deployments**  
  Build and update your server with a single command—no hassle, just gaming!

- **Full Control**  
  Manage, start, stop, and log your server with ease, so you can focus on the gameplay.

- **Built for Modders & Purists Alike**  
  Perfect for Vanilla players or mod enthusiasts—fully customizable to suit your style.
